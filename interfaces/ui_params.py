...
class UiParams(QtWidgets.QWidget):
    ...
    def configurarValidadores(self):
        ...
        self.txtCoefTardanza.setValidator(  QRegExpValidator(validador_coef, self.txtCoefTardanza))

        self.txtSeedClima.setValidator(     QRegExpValidator(validador_ent_positivo, self.txtSeedClima))
        self.txtSeedTardanza.setValidator(  QRegExpValidator(validador_ent_positivo, self.txtSeedTardanza))

        self.Prob_DS_DS.setValidator(QRegExpValidator(validador_proporcion, self.Prob_DS_DS))
        self.Prob_DS_DL.setValidator(QRegExpValidator(validador_proporcion, self.Prob_DS_DL))
        self.Prob_DS_DN.setValidator(QRegExpValidator(validador_proporcion, self.Prob_DS_DN))

        self.Prob_DL_DS.setValidator(QRegExpValidator(validador_proporcion, self.Prob_DL_DS))
        self.Prob_DL_DL.setValidator(QRegExpValidator(validador_proporcion, self.Prob_DL_DL))
        self.Prob_DL_DN.setValidator(QRegExpValidator(validador_proporcion, self.Prob_DL_DN))
        
        self.Prob_DN_DS.setValidator(QRegExpValidator(validador_proporcion, self.Prob_DN_DS))
        self.Prob_DN_DL.setValidator(QRegExpValidator(validador_proporcion, self.Prob_DN_DL))
        self.Prob_DN_DN.setValidator(QRegExpValidator(validador_proporcion, self.Prob_DN_DN))

        self.txtMediaTardanza.setValidator(QRegExpValidator(validador_ent_positivo, self.txtMediaTardanza))
    ...
    def cargarParametros(self):
        ...
        self.Prob_DS_DS.setText(str(self.parametros.prob_despues_de_dia_soleado[0]))
        self.Prob_DS_DL.setText(str(self.parametros.prob_despues_de_dia_soleado[1]))
        self.Prob_DS_DN.setText(str(self.parametros.prob_despues_de_dia_soleado[2]))

        self.Prob_DL_DS.setText(str(self.parametros.prob_despues_de_dia_lluvia[0]))
        self.Prob_DL_DL.setText(str(self.parametros.prob_despues_de_dia_lluvia[1]))
        self.Prob_DL_DN.setText(str(self.parametros.prob_despues_de_dia_lluvia[2]))

        self.Prob_DN_DS.setText(str(self.parametros.prob_despues_de_dia_nublado[0]))
        self.Prob_DN_DL.setText(str(self.parametros.prob_despues_de_dia_nublado[1]))
        self.Prob_DN_DN.setText(str(self.parametros.prob_despues_de_dia_nublado[2]))
    ...
    def guardarParametros(self):
        ...
        self.parametros.media_dias_tardanza_fertilizante = float(self.txtMediaTardanza.text())
